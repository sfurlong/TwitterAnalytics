...
/**
 * Example application that gets public timeline and store raw JSON strings into
 * statuses/ directory..<br>
 *
...
public final class SaveRawJSON {
	...
	public static void storeJSON(String rawJSON, String fileName)
		...
		try {
			...
			if (bw == null || rawJSON == null) {System.out.println("WTF: "+ fileName);}
			bw.write(rawJSON);
			bw.flush();
		} finally {
			if (bw != null) {
